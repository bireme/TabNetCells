    ...
    public static void main(final String[] args) throws UnsupportedEncodingException, IOException {
         ...
         */
         ...
         final Pattern CSV_PATTERN = Pattern.compile(
                                         "(?i)<a href=\"?([^\\.\n]+?.csv)\"?>");
         String targetURL = "http://tabnet.datasus.gov.br/cgi/tabcgi.exe?idb2011/c06.def";
         //final String targetURL = "http://tabnet.datasus.gov.br/cgi/tabnet.exe?idb2011/a16.def";
         String urlParameters = //"Incremento=Proporção_de_óbitos_(%)&Arquivos=obim09.dbf&SRegião_Metropolitana=TODAS_AS_CATEGORIAS__&SUnidade_da_Federação=TODAS_AS_CATEGORIAS__&Linha=Região_Metropolitana&SRegião=TODAS_AS_CATEGORIAS__&Coluna=--Não-Ativa--&SCapital=TODAS_AS_CATEGORIAS__";
                                      //"Incremento=Proporção_de_óbitos_(%)&Arquivos=obim10.dbf&SRegião_Metropolitana=TODAS_AS_CATEGORIAS__&SUnidade_da_Federação=TODAS_AS_CATEGORIAS__&Linha=Unidade_da_Federação&SRegião=TODAS_AS_CATEGORIAS__&Coluna=--Não-Ativa--&SCapital=TODAS_AS_CATEGORIAS__";
                                       ...
                                       "Incremento=Número_total_de_óbitos&Arquivos=obim10.dbf&SRegião_Metropolitana=TODAS_AS_CATEGORIAS__&SUnidade_da_Federação=TODAS_AS_CATEGORIAS__&Linha=Unidade_da_Federação&SRegião=TODAS_AS_CATEGORIAS__&Coluna=--Não-Ativa--&SCapital=TODAS_AS_CATEGORIAS__&formato=table&mostre=Mostra";
                                       //"Incremento=Proporção_de_óbitos_(%)&Arquivos=obim10.dbf&SRegião_Metropolitana=TODAS_AS_CATEGORIAS__&SUnidade_da_Federação=TODAS_AS_CATEGORIAS__&Linha=Região_Metropolitana&SRegião=TODAS_AS_CATEGORIAS__&Coluna=--Não-Ativa--&SCapital=TODAS_AS_CATEGORIAS__";
         final String encodedParams = URLEncoder.encode(urlParameters, "ISO8859-1");
         Matcher mat;
         ...
         System.out.println("=============================================\n\n\n");
         String[] content = URLS.loadPagePost(new URL(targetURL), urlParameters);
         mat = CSV_PATTERN.matcher(content[1]);
         if (mat.find()) {
            System.out.println(mat.group(1));
         }
         
         System.out.println("=============================================\n\n\n");
         content = URLS.loadPagePost(new URL(targetURL), urlParameters);
         mat = CSV_PATTERN.matcher(content[1]);
         if (mat.find()) {
            System.out.println(mat.group(1));
         }
         ...
         System.out.println("=============================================\n\n\n");
         urlParameters = "Incremento=Proporção_de_óbitos_(%)&Arquivos=obim10.dbf&SRegião_Metropolitana=TODAS_AS_CATEGORIAS__&SUnidade_da_Federação=TODAS_AS_CATEGORIAS__&Linha=Unidade_da_Federação&SRegião=TODAS_AS_CATEGORIAS__&Coluna=--Não-Ativa--&SCapital=TODAS_AS_CATEGORIAS__";
         content = URLS.loadPagePost(new URL(targetURL), urlParameters);
         mat = CSV_PATTERN.matcher(content[1]);
         if (mat.find()) {
            System.out.println(mat.group(1));
